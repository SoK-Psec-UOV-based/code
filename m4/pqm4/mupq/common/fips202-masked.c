...
void shake256_masked_inlen(unsigned char *output1, unsigned char *output2, unsigned long long outlen, const unsigned char *input1, const unsigned char *input2, const unsigned long long inlen)
{
// #ifdef PROFILE_HASHING
//   uint64_t time0 = hal_get_time();
// #endif
  ...
  /* Absorb input */
  keccak_absorb_masked(s1, s2, SHAKE256_RATE, input1, input2, inlen, 0x1f);
